                                        ...
                                        <table class="table center-aligned-table mb-0 table table-hover"
                                            ...
                                            @foreach($Student->images as $attachment)
                                                <tr style='text-align:center;vertical-align:middle'>
                                                    ...
                                                    <td>
                                                       <a data-fancybox="gallery" href="{{ url('attachments/students/'.$attachment->imageable->id.'/'.$attachment->filename) }}"><img width="50px" src="{{ url('attachments/students/'.$attachment->imageable->id.'/'.$attachment->filename) }}"></a>
                                                    </td>
                                                    <td colspan="2">
                                                        <a class="btn btn-outline-info btn-sm"
                                                           href="{{url('Download_attachment')}}/{{ $attachment->imageable->id }}/{{$attachment->filename}}"
