                                        ...
                                        @foreach($promotions as $promotion)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#graduated_student{{$promotion->student->id}}">تخرج الطالب</button>
                                                </td>
                                            </tr>
                                        @include('pages.Students.promotion.Delete_all')
                                        @include('pages.Students.promotion.Delete_one')
                                        @include('pages.Students.promotion.graduated_student')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
