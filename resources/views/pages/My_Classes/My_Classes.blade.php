    ...
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <br><br>
                ...
                <form action="{{ route('Filter_Classes') }}" method="GET">
                    <select class="selectpicker" data-style="btn-info" name="Grade_id" required
                            onchange="this.form.submit()">
                        <option value="" selected disabled>{{ trans('My_Classes_trans.Search_By_Grade') }}</option>
                        @foreach ($Grades as $Grade)
                            <option value="{{ $Grade->id }}" {{$Grade->id == app('request')->input('Grade_id') ? 'selected' : ""}}>{{ $Grade->Name }}</option>
                        @endforeach
                    </select>
                </form>
                                            ...
                                            <form action="{{ route('Classrooms.update', 'test') }}" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-lg"
                                                        ...
                                                        @foreach ($Grades as $Grade)
                                                            <option {{$Grade->id == $My_Class->Grades->id ? 'selected' : ""}} value="{{ $Grade->id }}">
                                                                {{ $Grade->Name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
