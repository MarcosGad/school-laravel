                                        ...
                                        @foreach($fees as $fee)
                                            ...
                                            <td>{{$fee->description}}</td>
                                                <td>
                                                    ...
                                                    <a href="{{ route('Fees.showS') }}" class="btn btn-warning btn-sm" role="button" aria-pressed="true" onclick="event.preventDefault();document.getElementById('show').submit();"><i class="far fa-eye"></i></a>
                                                    <form id="show" action="{{ route('Fees.showS') }}" method="POST" style="display: none;">
                                                        <input type="hidden" name="Grade_id" value="{{$fee->grade->id}}">
                                                        <input type="hidden" name="Classroom_id" value="{{$fee->classroom->id}}">
                                                        <input type="hidden" name="academic_year" value="{{$fee->year}}">
                                                        @csrf
                                                    </form>
                                                </td>
                                            </tr>
