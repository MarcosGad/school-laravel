...
class StudentController extends Controller
{
    ...
    public function attendanceSearch(Request $request){
        ...
        if($request->student_id == 0){
            $studentsSearch = Attendance::whereBetween('attendence_date', [$request->from, $request->to])->get();
            return view('pages.Teachers.dashboard.students.attendance_report',compact('studentsSearch','students'));
        }

        else{
            $studentsSearch = Attendance::whereBetween('attendence_date', [$request->from, $request->to])
